...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t19 = space();
    			t20 = text(t20_value);
    			add_location(h1, file, 36, 3, 627);
    			add_location(strong0, file, 37, 6, 656);
    			add_location(p0, file, 37, 3, 653);
    			add_location(strong1, file, 38, 6, 708);
    			add_location(p1, file, 38, 3, 705);
    			add_location(strong2, file, 39, 6, 756);
    			add_location(p2, file, 39, 3, 753);
    			add_location(strong3, file, 40, 6, 814);
    			add_location(p3, file, 40, 3, 811);
    			add_location(strong4, file, 41, 6, 874);
    			add_location(p4, file, 41, 3, 871);
    			add_location(article, file, 35, 2, 614);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 29, 1, 512);
    			add_location(header, file, 28, 0, 502);
    			add_location(main, file, 32, 0, 589);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const getPerson = async () => {
    		...
    		const response = await fetch(`https://swapi.co/api/people/${personId}`, { mode: "cors", method: "POST", headers });
